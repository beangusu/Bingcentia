...
## THIS LIST ASO REQUIRES THE MOST RECENT VERSION OF SKYRIM ALONG WITH THE $20 AE DLC!
...
- [PLEASE DO NOT CLOSE THIS! This modlist WILL NOT FUNCTION unless you follow the steps in this document!](#please-do-not-close-this-this-modlist-will-not-function-unless-you-follow-the-steps-in-this-document)
  - [THIS LIST ASO REQUIRES THE MOST RECENT VERSION OF SKYRIM ALONG WITH THE $20 AE DLC!](#this-list-aso-requires-the-most-recent-version-of-skyrim-along-with-the-20-ae-dlc)
- [Preamble](#preamble)
- [STRONG WARNINGS](#strong-warnings)
  ...
  - [THIS MODLIST MAY FEATURE GRAPHIC SEXUAL CONTENT THAT SOME PLAYERS MAY FIND DISTURBING OR OFFENSIVE. YOU MAY WISH TO AVOID IT IF YOU SUFFER FROM TRAUMA AS EXPLAINED BELOW.](#this-modlist-may-feature-graphic-sexual-content-that-some-players-may-find-disturbing-or-offensive-you-may-wish-to-avoid-it-if-you-suffer-from-trauma-as-explained-below)
  - [Requirements](#requirements)
    - [System Specs](#system-specs)
  - [Installation](#installation)
  - [Pre-Installation](#pre-installation)
    - [Installing Microsoft Visual C++ Redistributable Package](#installing-microsoft-visual-c-redistributable-package)
    - [Installing the latest DOT.NET Redistributable](#installing-the-latest-dotnet-redistributable)
...
![Bingcentia logo](Licentia.png "Bingcentia")
...
Welcome to the latest incarnation of _Licentia_ by Cacophoney, but I crank the visuals up to an 11, remove mods, add personal shit I like along with additions from the community and call it Bingcentia. This modlist is intended as a high fantasy "Game of Thrones" Skyrim, an ultimate power fantasy where you can use an incredible amount of perks and spells to make the hero you want, with just a touch of racy sexuality. Think of the sex as a minigame or a side thing you do while you adventure!
...
Before asking a question, look at [Troubleshooting](https://github.com/cacophony-wj/LeS/blob/master/TROUBLESHOOTING.md)! (replace with edited troubleshooting doc)

Many common questions can be answered there. However, should you need support for something I've added/changed, please open an issue on github or let me know in the unoffical lists support channel
